...
namespace Kata_Delegate
{
    class MemberList : IMemberList
    {
        ...
        public void VerifiedOnly(Func<Member,bool> Verification)
        {
            if (Verification == null) return;

            List<Member> _verified = new List<Member>();
            foreach (var item in _members)
            {
        ...
        public MemberList(int NrOfItems)
        {
            ...
            for (int i = 0; i < NrOfItems; i++)
            {
                ...
                try
                {
                    ...
                    string[] _names = "Fred John Mary Jane Oliver Marie Peter Kim".Split(' ');
